        ...
        <>
          <div className="fixed inset-x-0 bottom-0 z-40 border-t border-white/10 bg-[#090909]/95 backdrop-blur md:hidden">
            <div className="grid grid-cols-5 px-2 pt-2 pb-3">
              {mobileBottomLinks.map((link) => {
                ...
                return (
                  <Link
                    key={link.path}
                    to={link.path}
                    className={`flex flex-col items-center justify-center gap-1 rounded-2xl px-2 py-2 text-[11px] font-medium transition-colors ${
                      active ? "text-white bg-white/8" : "text-gray-400 hover:text-white"
                    }`}
                  >
              ...
              <button
                onClick={() => setShowMobileMenu(true)}
                className="flex flex-col items-center justify-center gap-1 rounded-2xl px-2 py-2 text-[11px] font-medium text-gray-400 transition-colors hover:text-white"
              >
          ...
          <Sheet open={showMobileMenu} onOpenChange={setShowMobileMenu}>
            <SheetContent side="left" className="w-[88vw] max-w-sm border-white/10 bg-[#111111] p-0 text-white">
                ...
                <div className="space-y-1">
                  ...
                  {onSwitchProfile && (
                    <button
                      ...
                      className="flex w-full items-center gap-3 rounded-2xl px-4 py-3 text-left text-sm text-gray-300 transition-colors hover:bg-white/5 hover:text-white"
                    >
                      <span className="w-4 h-4 flex items-center justify-center text-xs">P</span>
