    ...
    <div className="page-shell flex min-h-screen items-center justify-center px-5">
      <div className="surface-strong max-w-xl rounded-[32px] p-10 text-center">
        ...
        <p className="mt-4 text-base leading-7 text-[var(--color-text-muted)]">
          The page may have moved, the identifier may be invalid, or the external catalog no longer exposes this item.
        </p>
        <Link
          href="/"
          className="mt-8 inline-flex rounded-full bg-[var(--color-brand)] px-6 py-3 text-sm font-semibold text-[#07111f]"
        >
          Return Home
        </Link>
      </div>
